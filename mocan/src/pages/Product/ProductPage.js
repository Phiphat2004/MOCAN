            ...
            <div className="bg-white rounded-lg p-6 w-full max-w-md">
                      ...
                      {quickProduct.colors.map((c, i) => (
                        <button
                          ...
                          className={`w-8 h-8 rounded border ${
                            qpColor === c ? "ring-2 ring-lime-600" : ""
                          }`}
                          style={{ background: c }}
                        />
                      ))}
              ...
              <div className="mb-3 flex items-center gap-2">
                ...
                <div className="ml-auto flex items-center gap-2">
                  <button
                    onClick={() => setQpQty((q) => Math.max(1, q - 1))}
              ...
              <div className="flex justify-end gap-2">
                ...
                <button
                  onClick={() => {
                    ...
                    const item = {
                      id: quickProduct.id || quickProduct._id,
                      name: quickProduct.name,
                      price: quickProduct.price,
                      image: quickProduct.image,
                      quantity: qpQty,
                      stock: quickProduct.stock_quantity,
                      color: qpColor,
                      size: qpSize,
                    };
